/*******************************
 *
 * File: gb_dev_apogee_SP212_irradiance.cpp
 *
...
/******************************
 *
 * Name:        gb_dev_apogee_SP212_irradiance_open
 * Returns:     Nothing
 * Parameter:   Nothing
...
void gb_dev_apogee_SP212_irradiance_open(void){
    pinMode(_PIN_GB_APOGEE_SP212_IRRADIANCE_, INPUT);
}

/******************************
 *
 * Name:        gb_dev_apogee_SP212_irradiance_read_raw
...
int gb_dev_apogee_SP212_irradiance_read_raw(void){
    int value = analogRead(_PIN_GB_APOGEE_SP212_IRRADIANCE_);
    return value;
}

/******************************
 *
 * Name:        gb_dev_apogee_sp212_read
 * Returns:     Solar irradiance value in millivolts (mV)
 * Parameter:   Nothing
...
int gb_dev_apogee_SP212_irradiance_read(void){
    int value = 555;
    #ifndef SEN_STUB
    value = (float)analogRead(_PIN_GB_APOGEE_SP212_IRRADIANCE_)*(5000.0/1023.0);
    #endif
    return value;
}
