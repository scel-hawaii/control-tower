...
static void gg_board_setup(struct gg_board* b){
    ...
    pinMode(_PIN_GG_ATMEGA_LED1_,OUTPUT);
    pinMode(_PIN_GG_ATMEGA_LED3_,OUTPUT);
...
static void gg_board_post(){
    ...
    digitalWrite(_PIN_GG_ATMEGA_LED3_, HIGH);
    ...
    digitalWrite(_PIN_GG_ATMEGA_LED3_, LOW);
...
static void gg_board_heartbeat_tx(struct gg_board* b){
    ...
    digitalWrite(_PIN_GG_ATMEGA_LED1_, HIGH);
    ...
    digitalWrite(_PIN_GG_ATMEGA_LED1_, LOW);
}
